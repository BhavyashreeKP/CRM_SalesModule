      ...
      <div className="overflow-hidden rounded-xl border border-[#EFECE5] bg-white shadow-sm">
        <div className="border-b border-[#EFECE5] bg-[#FAF8F2] px-6 py-5">
          ...
          <dl className="space-y-2 text-sm">
            <div className="flex gap-3"><dt className="w-16 font-semibold text-gray-500">From:</dt><dd className="text-gray-800">{preview.from || '—'}</dd></div>
            <div className="flex gap-3"><dt className="w-16 font-semibold text-gray-500">To:</dt><dd className="text-gray-800">{preview.to || '—'}</dd></div>
